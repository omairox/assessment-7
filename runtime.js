...
let resultsAppendMed = perf.stop();  



perf.start();
doublerInsert(mediumArray);
let resultsInsertMed = perf.stop();


console.log('Results for the mediumArray');
console.log("insert", resultsInsertMed.preciseWords);
console.log("append", resultsAppendMed.preciseWords);
